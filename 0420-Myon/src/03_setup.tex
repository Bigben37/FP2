...
\begin{tabular}{|c|c|c|c|c|c|c|}
  \hline
  					& counter	& AND I	& AND II	& AND III	& counts				& count rate\footnotemark  / s$^{-1}$		\\ \hline
  ...
  underground		& Z III		& A B	& A	C		& A C		& 16/1000\,s			& \textbf{0.016\,$\pm$\,0.004}				\\ \hline
\end{tabular}
\end{center}
...
assuming a Poisson distribution of the error on the number of counts.}	
