...
\newcommand{\exptitleshort}{Muon decay} % short name of experiment
...
\DeclareMathOperator{\landau}{landau}
...
\newpage
All calculations and plots in this protocol were done with Python 3.4 using the following libraries
\begin{itemize}
