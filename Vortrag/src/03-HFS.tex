...
\begin{itemize}[<+->]
    ...
    \begin{equation*}
        ...
        \end{array}
    \end{equation*}
    \item Mögliche Fehler:
    \begin{itemize}[<+->]
        \item Laserfrequenz steigt nicht linear mit Strom
        \item Etalon im Strahlengang verkippt
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{figure}
    ...
    \caption{Spektrallinien der Hyperfeinstruktur von \rb{85} und \rb{87}.}
\end{figure}
...
\end{equation*}
\begin{table}
\caption{Errechnete HFS-Intervallkonstanten $A$ und Literaturwerte.}
\begin{center}
