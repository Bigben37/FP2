...
%TODO BEN: vorletzte und letzte Spalte *100
...
\end{center}
\end{figure}
%TODO y_Achse: Spannung der Photodiode Uph, Datenbeschriftung Spannung der Photodiode, Fit mit Uph(t)=.., x-Achse Zeit t /s
...
%TODO erste zwei spalten * 100
%TODO I sI / %
%TODO I_mess
%TODO Caption
Orientierungszeiten $\tau$ des Rubidiumensembles bei verschiedenen Pumpintensitäten $I_{\text{mess}}$.
...
%TODO x-Achse relative Intensität I_mess, yAchse inverse Orientierungszeit mit ^-1; legende inverse orientierungszeit; fit:alpha und T_R;


Das Ergebnis für die Relaxationszeit beträgt
\begin{equation}
  T_\text{R} = 3.67 \pm 0.02\,\text{ms}
\end{equation}
und stimmt..
%TODO vgl litval
