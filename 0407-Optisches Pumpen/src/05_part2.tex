...
\input{tab_part2_etalonfreqs_up}
\begin{figure}[H]
\begin{center}
...
\end{equation}
Für \rb{85} können wir die Intervallkonstante $A$ nicht berechnen, da jeweils zwei der vier Linien nicht einzelnd aufgelöst werden konnten. Die 
berechneten Werte von \rb{87} sind zusammen mit den Literaturwerten (aus \cite{manual}) in \autoref{tab:hfs:intervalconsts} aufgelistet. 
TODO Übereinstimmung %TODO Übereinstimmung
\input{tab_part2_A}