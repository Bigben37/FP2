...
\end{equation}
Für \rb{85} können wir die Intervallkonstante $A$ nicht berechnen, da jeweils zwei der vier Linien nicht einzeln aufgelöst werden konnten. Die 
berechneten Werte von \rb{87} sind zusammen mit den Literaturwerten \cite{manual} in \autoref{tab:hfs:intervalconsts} aufgelistet. 
