...
\begin{equation}
  T=\frac{t_2-t_1}{n}=f^{-1}
\end{equation}
Die Präzessionsfrequenz ist $f$ bezeichnet.
Der Fehler auf die abgelesenen Zeiten wurde abgeschätzt auf $s_{t_\text{i}}=XXX$\,ms,
$n$ ist nicht fehlerbehaftet.
%TODO Fehler Periodendauer

Aus dem Strom durch Spule~4 wurde mit \autoref{tab:inductorItoB} das erzeugte vertikale Magnetfeld
$B_\text{S,v}$ berechnet. Der Fehler auf den Strom beträgt $s_{I_4}=XXX$\,mA.
%TODO Fehler I4
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=\textwidth]{../img/part4/SPP_Rb85.pdf}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=\textwidth]{../img/part4/SPP_Rb87.pdf}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=\textwidth]{../img/part4/SPP_Rb85_gedreht.pdf}
  \caption{Spinpräzessionsfrequenz $f$ von \rb{85} in Abhängigkeit
  vom zusätzlichen vertikalen Magnetfeld $B_\text{S,v}$
...
\begin{figure}[H]
\begin{center}
  \includegraphics[width=0.6\textwidth]{../img/part4/Winkelabhaengigkeit.pdf}
