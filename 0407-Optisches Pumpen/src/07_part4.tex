...
\begin{center}
  ...
  \caption{Spinpräzession des Rubidiumensembles, sichtbar in der Transmissionsoszillation der Messzelle.} %TODO Legende
  \label{img:spp:expl}
\end{center}
\end{figure} 

%TODO zweite Abbildung mit höherer Frequenz
